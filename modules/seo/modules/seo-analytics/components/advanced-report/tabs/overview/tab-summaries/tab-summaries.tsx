...
export const TabSummaries = memo(function TabSummaries({ onTabChange: _onTabChange }: TabSummariesProps) {
...
return (
  <div className="space-y-6">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      {/* Recommendations Section - 8 columns - REMOVED FROM HERE */}
      <div className="lg:col-span-8 w-full">
        {/* Espacio vacío o puedes agregar otro componente aquí */}
      </div>
    </div>
  </div>
);
