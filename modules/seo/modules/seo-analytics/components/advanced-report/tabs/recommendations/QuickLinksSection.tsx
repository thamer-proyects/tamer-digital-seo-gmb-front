...
const quickLinks: QuickLink[] = [
  {
    key: 'crawlability',
    title: 'Crawlability',
    description: 'Tracking and Budget Optimization',
    icon: Sliders,
    issues: 3,
  },
  {
    ...
    description: 'Structure and distribution of links',
    icon: Link,
    issues: 2,
  },
  {
  ...
  },
  {
    key: 'hreflang',
    title: 'Hreflang',
    description: 'International and multilingual SEO',
    icon: Globe2,
    issues: 3,
  },
  {
  ...
  },
  {
    key: 'backlinks',
    title: 'Backlinks',
    description: 'Incoming Link Profile',
    icon: ExternalLink,
    issues: 4,
  },
];
